...
const mainContent = document.querySelector('body'); // Changed to target the body

const showSidebar = () => sidebar.classList.add('active');
const hideSidebar = () => sidebar.classList.remove('active');

/* Set main content top padding based on navbar height */
...
const updateNavbarScrollState = () => {
    if (window.innerWidth > 1024) {
        ...
        setBodyPadding(); // Call padding function on scroll to maintain correct spacing
    }
};
